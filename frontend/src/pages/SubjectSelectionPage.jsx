...
const SubjectSelectionPage = () => {
  ...
  useEffect(() => {
    ...
    if (userData.isProfileComplete===true) {
      ...
      firstTimeGreet = "The user is not a new user so greet him as a returning user, don't use the word returning user, just greet the user as a returning user "
  ...
  return (
    ...
    <h2 className="text-5xl font-bold mb-6 text-slate-100">Your Subjects</h2>

    <div className="my-5 w-full max-w-6xl text-indigo-100 text-justify font-semibold "
